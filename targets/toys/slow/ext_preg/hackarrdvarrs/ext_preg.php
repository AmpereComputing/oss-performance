<?hh
namespace slowextpreghackarrdvarrsextpreg;
...
function test_preg_replace() {
  ...
  VS(preg_replace("/xxx", "w", array("xxxx")), dict[]);
  VS(preg_replace("/xxx/", "w", array("xxxx")), dict(array("wx")));
  VS(preg_replace("/xxx/", "w", array("xxxx", "yyyy")), dict(array("wx", "yyyy")));
  VS(preg_replace(array("/xxx/", "/xxx"), "w", array("xxxx")), dict[]);
  VS(preg_replace(array("/xxx/", "/xxx/"), "w", array("xxxx")), dict(array("wx")));

  VS(preg_replace("/xxx", array("w"), array("xxxx")), false);
  VS(preg_replace(array("/xxx"), array("w"), array("xxxx")), dict[]);
  VS(preg_replace(array("/xxx/"), array("w"), array("xxxx")), dict(array("wx")));
}
